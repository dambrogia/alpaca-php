...
use Dambrogia\Alpaca\Endpoint\V2\Account;
use Dambrogia\Alpaca\Endpoint\V2\Assets;
use Dambrogia\Alpaca\Endpoint\V2\Calendar;
use Dambrogia\Alpaca\Endpoint\V2\Clock;
use Dambrogia\Alpaca\Endpoint\V2\Orders;
use Dambrogia\Alpaca\Endpoint\V2\Positions;
...
class V2 extends AbstractClient
{
    /**
